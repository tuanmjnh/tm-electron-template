export default {
  ...
  product: {
    ...
    code: 'Mã sản phẩm',
    brand: 'Thương hiệu',
    originName: 'Tên nhà sản xuất',
    originAddress: 'Địa chỉ nơi sản xuất',
    weight: 'Cân nặng',
    date: 'Năm sản xuất',
    ...
    type: 'Phân loại hàng',
    addGroupType: 'Thêm nhóm phân loại hàng',
    addType: 'Thêm phân loại hàng',
    typeOne: 'Nhóm phân loại 1',
    typeTwo: 'Nhóm phân loại 2',
    nameType1: 'Tên NPL 1',
    codeType1: 'Mã NPL 1',
    nameType2: 'Tên NPL 2',
    codeType2: 'Mã NPL 2',
    typeName: 'Tên nhóm',
    typeList: 'Danh sách phân loại',
  ...
  store: {
    ...
    msgBillCreated: 'Đơn hàng chưa xác nhận',
  ...
  tabs: {
    basicInf: 'Thông tin cơ bản',
    detailsInf: 'Thông tin chi tiết',
    mediaInf: 'Phương tiện truyền thông',
    salesInf: 'Thông tin bán hàng',
    shippingInf: 'Thông tin vận chuyển',
    ortherInf: 'Thông tin khác',
    inf: 'Thông tin',
  ...
  table: {
    ...
    actions: '#',
    temporaryData: 'Dữ liệu trên tệp'
  },
  files: {
    title: 'Danh sách tệp',
    upload: 'Tải tệp',
