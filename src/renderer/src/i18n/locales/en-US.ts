export default {
  ...
  product: {
    ...
    code: 'Product code',
    brand: 'Brand',
    originName: 'Manufacturers Name',
    originAddress: 'Address of the place of manufacture',
    weight: 'Ưeight',
    ...
    typeOne: 'Type one',
    typeTwo: 'Type two',
    nameType1: 'Name Type 1',
    codeType1: 'Code Type 1',
    nameType2: 'Name Type 2',
    codeType2: 'Code Type 2',
    typeName: 'Type name',
    typeList: 'Type list',
  ...
  store: {
    ...
    confirm: 'Confirmed',
    cancel: 'Cancelled',
    exportConfirm: 'Are you sure you want to create an order?',
    ...
    msgBillCreated: 'Unconfirmed order',
  ...
  tabs: {
    ...
    detailsInf: 'Details',
    mediaInf: 'Media',
    salesInf: 'Sales Information',
    shippingInf: 'Shipping Information',
    ortherInf: 'Orther information',
    inf: 'Information',
  ...
  table: {
    ...
    actions: '#',
    temporaryData: 'Viewing data in file'
  },
  files: {
    title: 'List file',
    upload: 'Upload',
